...
var mainstate = {
    ...
    preload: function (){
        ...
        game.load.spritesheet('sumoto','asset/sumoto/spritesheet.png',50,50,7)
    },
    create: function (){
        ...
        this.player = game.add.sprite(startX,startY,'sumoto')
        game.physics.arcade.enable(this.player);
        this._anims.create({
            key:'left',
            frames: this._anims.generateFrameNumber('sumoto',{start: 5, end: 6}),
            framerate: 60,
            repeat: -1
            });
